      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex items-center justify-between mb-12">
          ...
          <a
            ...
            className="flex items-center gap-2 px-6 py-3 bg-gray-900 text-white rounded-full hover:bg-gray-800 transition font-semibold"
          >
          ...
          {projects.map((project, index) => (
            <div key={index} className="perspective-1000 h-96 group">
              <div className="flip-card-inner relative w-full h-full transition-transform duration-700 transform-style-3d">
                {/* Front */}
                <div
                  className={`absolute inset-0 backface-hidden bg-gradient-to-br ${project.color} border-4 border-gray-900 rounded-2xl p-8 flex flex-col items-center justify-center shadow-lg`}
                >
                  {project.icon}
                ...
                {/* Back */}
                <div className="absolute inset-0 backface-hidden rotate-y-180 bg-gray-900 border-4 border-gray-900 rounded-2xl p-8 shadow-lg flex flex-col">
                  ...
                  <div className="pt-4 mt-4 border-t border-gray-700">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech, i) => (
                        <span
                          key={i}
                          className="px-3 py-1 text-xs font-semibold rounded-full bg-gray-800 text-gray-200 border border-gray-700"
                        >
                          {tech}
                        </span>
                      ))}
